...
def main():
    ...
    print("\n--- DATASET REPORT ---")
    diseases = sorted([d for d in os.listdir(DATA_DIR) if os.path.isdir(os.path.join(DATA_DIR, d))])
    for idx, disease in enumerate(diseases):
        ...
        colors.append(group_colors[idx % len(group_colors)])
    ...
    for disease in all_diseases:
        ...
        if len(valid_images) > 0:
            ...
            try:
                ...
                axes[idx_counter].set_title(disease, fontsize=9)
