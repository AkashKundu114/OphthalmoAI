...
Demonstrates CPU multi-core thread scheduling on AMD Ryzen 9 HX (32 threads),
vectorized CPU BLAS matrix multiplication, and full hardware telemetry.
"""
...
def parse_args():
    ...
    parser.add_argument("--threads", type=int, default=os.cpu_count() or 4, help="CPU threads for PyTorch (Ryzen 9 HX)")
...
def main():
    ...
    print("=" * 70)
    print("CPU-OPTIMIZED RESNET50 RETINAL FUNDUS TRAINING (RYZEN 9 HX)")
