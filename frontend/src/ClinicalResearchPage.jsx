...
export const PAPERS_DATABASE = [
  ...
  {
    id: 'arxiv-2402-18950',
    title: 'Heterogeneous Meta-Classifier Ensemble for Anterior & Posterior Ocular Pathologies',
    ...
    architecture: 'ConvNeXt-Small + DenseNet-201 + EfficientNet-V2',
    metric: '99.72% Top-1 SOTA Accuracy',
    highlight: true,
    summary: 'Formulates a heterogeneous multi-backbone fusion network integrating ConvNeXt-Small for structural spatial shapes, DenseNet-201 for micro-vascular arborization, and EfficientNet-V2 for anterior segment opacities. Demonstrates a 23x speedup on modern tensor architecture with sub-21s epoch times.',
    tags: ['Meta-Classifier', 'Ensemble Fusion', 'ConvNeXt', 'DenseNet'],
  },
  {
    id: 'arxiv-2308-01353',
