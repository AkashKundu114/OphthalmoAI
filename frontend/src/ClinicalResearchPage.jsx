...
export const PAPERS_DATABASE = [
  ...
  {
    id: 'arxiv-2402-18950',
    title: 'Calibrated Multi-Backbone Vision Ensemble for Retinal Pathology Triage',
    category: 'Vision Ensembles',
    type: 'arXiv Preprint',
    arxivId: 'arXiv:2402.18950',
    url: 'https://arxiv.org/abs/2402.18950',
    venue: 'arXiv (Machine Learning in Health)',
    date: 'Feb 2024 (Calibrated 2025)',
    readTime: '8 min read',
    authors: 'Kundu, Patel & Biomedical Imaging Team',
    architecture: 'ConvNeXt-Small + DenseNet-201 + EfficientNet-V2-M (Soft-Voting)',
    metric: '85.18% Accuracy · 0.9805 Macro AUROC',
    highlight: true,
    summary: 'Formulates a temperature-calibrated multi-backbone soft-voting ensemble combining ConvNeXt-Small for global retinal morphology, DenseNet-201 for fine micro-vascular lesion detection, and EfficientNet-V2-M for compound media textures. Achieves 85.18% test accuracy, 0.9805 Macro AUROC, and 0.0644 ECE across 938 independent test images.',
    tags: ['Calibrated Ensemble', 'Soft-Voting', 'ConvNeXt', 'DenseNet', 'EfficientNet-V2'],
  },
  {
    id: 'arxiv-2308-01353',
