  ...
  const policySections = [
    {
      ...
      content: (
        <div className="space-y-3 text-xs text-slate-600 leading-relaxed">
          ...
          <div className="p-4 rounded-xl bg-teal-50/90 border border-teal-200 text-teal-900">
            <span className="font-bold text-teal-800 block mb-1">Zero Commercial Monetization Guarantee</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 pt-1">
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
              <span className="font-bold text-slate-900 text-xs flex items-center gap-2">
                <Eye className="w-4 h-4 text-cyan-600" /> Ocular Imaging Data
              </span>
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
              <span className="font-bold text-slate-900 text-xs flex items-center gap-2">
                <FileText className="w-4 h-4 text-teal-600" /> Clinical Symptom Indicators
              </span>
              <p className="text-[11px] text-slate-600">
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
              <span className="font-bold text-slate-900 text-xs flex items-center gap-2">
                <FileCheck className="w-4 h-4 text-indigo-600" /> Optional Systemic Biomarkers
              </span>
              <p className="text-[11px] text-slate-600">
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-2">
              <span className="font-bold text-slate-900 text-xs flex items-center gap-2">
                <Server className="w-4 h-4 text-amber-600" /> Operational & Hardware Telemetry
              </span>
              <p className="text-[11px] text-slate-600">
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-xs text-slate-600 leading-relaxed">
          ...
          <ol className="space-y-2 list-decimal list-inside pl-1 text-slate-600">
            <li>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={idx} className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 flex items-start gap-2.5">
                ...
                <div>
                  <strong className="text-slate-900 text-xs block">{item.title}</strong>
        ...
        <div className="space-y-3 text-xs text-slate-600 leading-relaxed">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
              <span className="text-xs font-bold text-amber-800 block">TLS 1.3 Transport</span>
              <p className="text-[11px] text-slate-600">
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
              <span className="text-xs font-bold text-teal-800 block">AES-256 at Rest</span>
              <p className="text-[11px] text-slate-600">
            ...
            <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
              <span className="text-xs font-bold text-cyan-800 block">Isolated Enclaves</span>
              <p className="text-[11px] text-slate-600">
  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-5xl mx-auto px-1 sm:px-2">
      ...
      <div className="border-b border-slate-200 pb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold bg-teal-50 text-teal-800 border border-teal-200 mb-2">
            <Lock className="w-3.5 h-3.5 text-teal-600" /> Clinical Data Protection & Privacy Governance
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <FileText className="w-3.5 h-3.5 text-cyan-600" /> View Terms & Conditions
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
        {[
          { label: 'Zero Ad Monetization', desc: 'No commercial sale of clinical images', color: 'border-emerald-200 bg-emerald-50 text-emerald-800' },
          { label: 'HIPAA De-Identified', desc: 'Safe harbor compliant intake', color: 'border-cyan-200 bg-cyan-50 text-cyan-800' },
          { label: 'TLS 1.3 Transport', desc: 'Encrypted client-to-inference socket', color: 'border-teal-200 bg-teal-50 text-teal-800' },
          { label: 'FHIR R4 Portability', desc: 'Open standard interoperability', color: 'border-indigo-200 bg-indigo-50 text-indigo-800' },
        ].map((badge, bi) => (
          <div key={bi} className={`p-3.5 rounded-2xl border ${badge.color} space-y-1 shadow-2xs`}>
            <span className="text-xs font-bold block">{badge.label}</span>
            <span className="text-[10px] text-slate-600 block">{badge.desc}</span>
          </div>
        ))}
      </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1">
            <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
              <Mail className="w-4 h-4 text-teal-600" /> Data Protection Officer (DPO) Contact
            </h3>
            ...
            <div className="pt-1 font-mono text-xs text-teal-700">
              <a href="mailto:akashkundu1152@gmail.com" className="hover:underline text-teal-700 font-medium">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <button
              onClick={() => onNavigate('diagnostic')}
              className="px-6 py-3 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-500 hover:to-cyan-500 shadow-md shadow-teal-600/20 transition flex items-center justify-center gap-2"
            >
